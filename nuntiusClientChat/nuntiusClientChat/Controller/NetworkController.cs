		...
		public static async Task<Response> SendReqestToServerAsync(Request request)
		{
			...
			try
			{
				...
				try
				{
					...
					string text = userPrivKey.DecryptString(b);
